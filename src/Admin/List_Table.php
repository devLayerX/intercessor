<?php
/**
 * Abstract Intercessor List Table class
 *
 * This class can be extended by custom list tables.
 *
 * @package     Intercessor
 * @subpackage  Classes/List_Table
...
abstract class List_Table extends \WP_List_Table {
    ...
    public function get_views() {
        ...
        // Args to remove
        $remove = array( 'intercessor-message', 'status', 'paged', '_wpnonce' );
        ...
        $this->domain = 'intercessor';
        $label = __( 'All', '' . $this->domain . '') . $count;
        $views = array(
        ...
        if ( ! empty( $counts ) ) {
            foreach ( $counts as $status => $count ) {
                ...
                $label            = intercessor_get_status_label( $status ) . $count;
