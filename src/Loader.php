...
final class Loader {
	 ...
	 * @since  1.0.0
	 * @access public
	 * @return \wpdb|false The database connection or false if it is not available.
	 */
	public function get_db() {
        // Initialize the return value to false.
		$retval = false;

		// Check if the global $wpdb variable is set.
		if ( isset( $GLOBALS['wpdb ' ] ) ) {
			$retval = $GLOBALS['wpdb ' ];
		}

		// Return the database connection or false if it is not available.
		return $retval;
    }
}
